...
M=250; %Number samples kept will be 2M+1
start = N/2 + 1-M;
end1 = N/2 + 1+M;
...
d2b = d2b';    
transmitted=bch_encode11(d2b);
received = bsc_apoorv(transmitted,0.5); #Change probability of error here
answer1 = bch_decode11(received);
answer1 = answer1';
d2b = answer1;
